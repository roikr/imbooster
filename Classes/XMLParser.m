...
- (void)parser:(NSXMLParser *)parser didStartElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName attributes:(NSDictionary *)attributeDict {
    ...
    if (parsedAssetsCounter >= kMaximumNumberOfAssetsToParse) {
		...
		NSScanner *scanner = [NSScanner scannerWithString:[attributeDict valueForKey:@"md"]];
        unsigned charCode;
        [scanner scanHexInt:&charCode];
       
		Asset *asset = [[Asset alloc] initWithNumber:parsedAssetsCounter withSection:currentSectionNumber withCategory:currentCategoryNumber withIdentifier:[attributeDict valueForKey:@"aid"] withCharCode:charCode
											withType:[[attributeDict valueForKey:@"t"] intValue] withProductIdentifier:[attributeDict valueForKey:@"pidfr"] withPurchaseID:[attributeDict valueForKey:@"pid"] 
